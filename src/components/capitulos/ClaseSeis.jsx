...
const ClaseSeis = () => {
  ...
  `;
  const codeString2 =`
  useEffect (() => { funcion-a-ejecutar }, [ array-de-dependencias ]);
  `
  return (
      <Card className="mb-2">
            <Card.Header className='apuntes-react'><Badge pill bg="dark">Clase Nº 6 </Badge><h1>Promises: Asincronia y MAP</h1></Card.Header>
            <Card.Body>
                ...
                <Card.Text>
                    ...
                    <p>Los datos obtenidos de la promesa estan encapsulados en un array para mostrarlos en pantalla tenemos que hacer uso del metodo .map que nos va a permitir recorrer el array e ir retornando JSX para renderizar la info en el navegador.</p>
                </Card.Text>
